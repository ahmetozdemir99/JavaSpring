...
public class StudentController { // Bütün return typeler değişebilir . Response ve Request packageına yeni classlar eklenmeli frontendden hangi bilgi istendiğine göre
    ...
    public StudentController(AWSService awsService,StudentService studentService, CandidateService candidateService,ElectionService electionService, FolderRepo folderRepo, FileRepo fileRepo, ApplyCandidacyService applyCandidacyService) {
