...
public class OfficerController {
    ...
    @GetMapping("/confirmCandidate/{studentNumber}") // it returns candidate because application is confirmed. Student is candidate right now.
    ...
    @GetMapping("/rejectCandidate/{studentNumber}") //  it returns student . If applications is not approved by officer , student is still student not candidate!!
